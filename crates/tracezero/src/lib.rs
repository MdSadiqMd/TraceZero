//! TraceZero - Network privacy library for Tor routing
//!
//! This crate provides SOCKS5 and HTTP clients that route all traffic
//! through the Tor network for complete anonymity.
//!
//! ```rust,no_run
